...
/** The standard Ink specs, grabbed as per 2017.02.07
 */
class InkStandardSpec : WordSpec() {

  init {

    "Ink standard spec" should {

      "TestArgumentNameCollisions1" {
        val testFile = """=== test_knot
VAR global_var = 5
...
=== knot_name ===
    -> END
      """.trimMargin()
        ...
        val inputStream = IOUtils.toInputStream(testFile, "UTF-8")
