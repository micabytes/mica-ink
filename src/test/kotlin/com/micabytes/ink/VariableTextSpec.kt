  ...
  init {
    "Sequences" should {
      ...
      "- step through each element and repeat the final element" {
        ...
        text1.get(0) shouldBe ("The radio hissed into life. \"Two!\"")
        story.choose(0)
        val text2 = story.next()
        text2.size shouldBe (1)
        text2.get(0) shouldBe ("The radio hissed into life. \"One!\"")
        story.choose(0)
        val text3 = story.next()
        text3.size shouldBe (1)
        text3.get(0) shouldBe ("The radio hissed into life. There was the white noise racket of an explosion.")
        story.choose(0)
        val text4 = story.next()
        text4.size shouldBe (1)
        text4.get(0) shouldBe ("The radio hissed into life. There was the white noise racket of an explosion.")
      }
    }
    ...
    "Cycles" should {
      ...
      "- cycle through the element repeatedly" {
        ...
        val text3 = story.next()
        text3.size shouldBe (1)
        text3.get(0) shouldBe ("The radio hissed into life. \"Three!\"")
        story.choose(0)
        val text4 = story.next()
        text4.size shouldBe (1)
        text4.get(0) shouldBe ("The radio hissed into life. \"Two!\"")
      }
    }
    ...
    "Once-only lists" should {
      ...
      "- step through each element and return no text once the list is exhausted" {
        ...
        val text3 = story.next()
        text3.size shouldBe (1)
        text3.get(0) shouldBe ("The radio hissed into life.")
        story.choose(0)
        val text4 = story.next()
        text4.size shouldBe (1)
        text4.get(0) shouldBe ("The radio hissed into life.")
      }
    }
    ...
    "Declaration text" should {
      ...
      "- allow for empty text elements in the list" {
        ...
        val text1 = story.next()
        text1.size shouldBe (1)
        text1.get(0) shouldBe ("The radio hissed into life.")
        story.choose(0)
        val text2 = story.next()
        text2.size shouldBe (1)
        text2.get(0) shouldBe ("The radio hissed into life. \"One!\"")
      ...
      "- be usable in a choice test" {
        ...
        story.choose(0)
        story.next()
        story.choiceText(1) shouldBe ("\"Hello, Monsieur!\"")
        story.choose(0)
        story.next()
