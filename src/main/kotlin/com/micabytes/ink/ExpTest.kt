 ...
 */
class ExpTest(val expression: String, val defaultMathContext: MathContext = MathContext.DECIMAL32)
{
...
*/
   ...
   */
  fun setPrecision(precision: Int): ExpTest {
   ...
   * @return The expression, allows to chain methods.
   */
  fun setRoundingMode(roundingMode: RoundingMode): ExpTest {
